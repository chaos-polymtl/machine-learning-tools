...
class PINeuralNet(nn.Module):
    ...
    def __init__(self, device, k, neurons):
        ...
        Args:
            ...
            k (list): Initial estimates for kinetic parameters
            neurons (int): Number of neurones in each hidden layer
        """
...
# Full PINN to discover the kinetic constants
class Curiosity():
    ...
    def __init__(self, X, Y, idx, idx_y0, f_hat, learning_rate, k, neurons, regularization, device):
        ...
        Args:
            ...
            idx_y0 (list): Indexation of IC points in collocation points
            ...
            regularization (float): Regularization parameters for MSE of ODEs
            device (string): CPU or CUDA
        """
    ...
    def loss(self, x, y_train):
        ...
        Args:
            x (tensor): Input tensor
            y_train (tensor): Output tensor (real values)
